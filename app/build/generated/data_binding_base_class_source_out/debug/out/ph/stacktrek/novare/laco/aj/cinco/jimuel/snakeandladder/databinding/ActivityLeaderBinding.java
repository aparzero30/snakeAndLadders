...
public final class ActivityLeaderBinding implements ViewBinding {
  ...
  private ActivityLeaderBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityLeaderBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityLeaderBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_leader, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityLeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLeaderBinding((ConstraintLayout) rootView, back, bottomGuideline, frame1,
          frame2, frame3, frame4, frame5, leaderboard, leftGuideline, top1, top2, top3, top4, top5,
          topGuideline);
    }
